...
import edu.monash.fit2081a1.adapters.EvRecyclerAdapter;
...
public class FragmentListEvent extends Fragment {
    ...
    public static EvRecyclerAdapter adapter;
    Gson gson = new Gson();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.evRecyclerView);
